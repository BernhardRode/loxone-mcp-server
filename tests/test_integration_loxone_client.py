    ...
    async def test_connect_to_real_miniserver(self, real_config):
        ...
        try:
            ...
            if success:
                ...
                logger.warning("Failed to connect to MiniServer - this may be expected in test environment")
    ...
    async def test_authentication_flow_with_real_server(self, real_config):
        ...
        try:
            ...
            if success:
                ...
                logger.info(f"Authentication successful, token expires in {client._token.get_seconds_to_expire()} seconds")

...
async def loxone_get_device_state(
    ...
    try:
        ...
        try:
            ...
            logger.info(f"Successfully retrieved enhanced state for device '{device.name}' ({device.type})")
...
def main():
    ...
    logger.info("Available tools: loxone_list_devices, loxone_get_device_state, loxone_test_connection")
    mcp.run()

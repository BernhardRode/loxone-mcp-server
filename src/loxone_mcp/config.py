...
class LoxoneConfig:
    ...
    def from_env(cls) -> 'LoxoneConfig':
        ...
        if missing_fields:
            ...
            logger.error("  LOXONE_TOKEN_PATH - Token persistence path (default: ./loxone_token.json)")
        ...
        logger.info(f"Loaded configuration from environment: host={host}, port={port}, username={username}")
